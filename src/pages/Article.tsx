...
const Article = () => {
          ...
          <Card className="overflow-hidden border border-border rounded-xl shadow-xl">
            ...
            <CardContent className="space-y-6 text-lg leading-relaxed">
              ...
              <p>
                ...
                securely transmitting information between two parties as a JSON
                object. It's commonly used for authentication and authorization
  ...
  secret
              ...
              <h2 className="text-2xl font-semibold pt-6">Where JWT is Used</h2>
              <ul className="list-disc list-inside">
